...
| :--- | :--- | :---: |
| [shopee-rewards-business-analysis.md](./shopee-rewards-business-analysis.md) | Hồ sơ phân tích nghiệp vụ: 10 BR, 2 Pain Points, Scope & Solution Design chi tiết | ✅ Hoàn thành |
| [shopee-rewards-diagrams.md](./shopee-rewards-diagrams.md) | Đặc tả kỹ thuật sơ đồ: Flowchart, Sequence, Solution Architecture kèm mã nguồn Mermaid | ✅ Hoàn thành |
